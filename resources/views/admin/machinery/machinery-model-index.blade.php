        ...
        <tbody>
            ...
            <tr wire:key="mmodel-{{ $item->id }}">
                ...
                <td class="cell-actions">
                    ...
                    <button class="icon-btn" wire:click="delete({{ $item->id }})" data-confirm="{{ $confirm[$item->id] ?? 'Ви дійсно хочете видалити модель?' }}" title="Видалити" aria-label="Видалити"><x-icon name="trash"/></button>
                </td>
            </tr>
            @empty
