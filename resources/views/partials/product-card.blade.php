{{-- resources/views/partials/product-card.blade.php
     ...
     $p: size, brand, model, constr, li, app, stock, img, price_mode, price, promos[].
        ...
        <div class="cat-prod__info">
            ...
            <div class="cat-prod__head">
                ...
                <span class="cat-prod__app-badge" title="{{ $p['app'] }}" aria-label="{{ $p['app'] }}">
                    <span class="mask-ico"
                        style="-webkit-mask-image:url('/images/svg/tehnics/{{ $appIcon }}');mask-image:url('/images/svg/tehnics/{{ $appIcon }}')"></span>
                </span>
            </div>
            ...
            <ul class="cat-prod__specs">
                ...
                <li class="cat-prod__app">{{ $p['app'] }}</li>
            </ul>
