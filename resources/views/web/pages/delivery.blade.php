    ...
    <div class="container">
        ...
        <div class="info-page__wrap">
            ...
            <div class="info-page__body">
                ...
                <p>Основний спосіб оплати у нас - <b>безготівковий розрахунок</b> за рахунком
                    (зручно для фізичних та юридичних осіб, з усіма документами).</p>
                <ul>
                    <li><b>Безготівковий розрахунок</b> - оплата за реквізитами/рахунком (основний спосіб).</li>
                    <li><b>Післяплата</b> - оплата при отриманні товару, за домовленістю.</li>
                </ul>
